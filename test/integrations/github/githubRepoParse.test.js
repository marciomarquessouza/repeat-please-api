...
describe('integrations/github/parses/githubRepoParse', () => {
    it('Should return a normalized reponse from github', (done) => {
        githubRepoParse(JSON.stringify(githubResponse), (error, response) => {
    ...
    it('Should return a parse error with code 502', (done) => {
        githubRepoParse(githubResponse, (error, response) => {
